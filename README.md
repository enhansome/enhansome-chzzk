...
* [kyechan99/chzzk-plus](https://github.com/kyechan99/chzzk-plus) ⭐ 60 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-18 - Chzzk 치지직 확장프로그램 `Typescript` `MIT License` ([익스텐션 설치](https://chromewebstore.google.com/detail/chzzk-plus/miampiopgfpnimmggagljgbpmjmjdjia))
* [khk4912/Chzzk-PIP](https://github.com/khk4912/Chzzk-PIP) ⭐ 25 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-10 - 치지직 PIP, 녹화 버튼 추가 확장 `Typescript` ([익스텐션 설치](https://chromewebstore.google.com/detail/chzzk-pip/gkgpbobdiaaodjbmgdankimklclnagio))
* [jebibot/cheese-knife](https://github.com/jebibot/cheese-knife) ⭐ 24 | 🐛 21 | 🌐 JavaScript | 📅 2026-09-21 - 네이버 스트리밍 플랫폼 치지직에 다양하고 유용한 기능과 도구를 추가합니다. `Javascript` `MIT License` ([익스텐션 설치](https://chromewebstore.google.com/detail/nfkfgkkhgglkgnlppncolmpekidapkjh))
...
* [2jun0/chzzk-ad-autoskipper](https://github.com/2jun0/chzzk-ad-autoskipper) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2025-03-15 - 치지직 광고 스키퍼 `Javascript` `MIT License` ([익스텐션 설치](https://chromewebstore.google.com/detail/치지직-광고-스키퍼/dfckileffglgodofacjbhbglplojmcfl))
* [Cl4nn5/chzzk\_shortcut](https://github.com/Cl4nn5/chzzk_shortcut) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2024-06-04 - 치지직 비디오 플레이어 단축키 적용 `Javascript`
...
* \[Node.js] [kimcore/chzzk](https://github.com/kimcore/chzzk) ⭐ 211 | 🐛 3 | 🌐 TypeScript | 📅 2024-08-13 - 네이버 라이브 스트리밍 서비스 CHZZK의 비공식 API 라이브러리 `Typescript` `MIT License` ([NPM](https://www.npmjs.com/package/chzzk))
...
* \[Unity] [JoKangHyeon/ChzzkUnity](https://github.com/JoKangHyeon/ChzzkUnity) ⭐ 23 | 🐛 0 | 🌐 C# | 📅 2024-11-26 - Unity Chzzk chatting/donation Connection `C#`
* \[Python] [jonghwanhyeon/python-chzzk](https://github.com/jonghwanhyeon/python-chzzk) ⭐ 13 | 🐛 2 | 🌐 Python | 📅 2025-01-18 - An unofficial Python library for CHZZK `Python` `MIT License` ([PyPI](https://pypi.org/project/python-chzzk/))
* \[Node.js] [Kwabang/chzzk-sdk](https://github.com/Kwabang/chzzk-sdk) ⭐ 10 | 🐛 0 | 🌐 JavaScript | 📅 2024-09-18 - Node.js SDK `Javascript` `AGPL-3.0 License` ([NPM](https://www.npmjs.com/package/chzzk-sdk))
* \[Rust] [5-23/chzzk-rs](https://github.com/5-23/chzzk-rs) ⭐ 6 | 🐛 1 | 🌐 Rust | 📅 2025-04-09 - Unofficial SDK of Korean live platform chzzk `Rust` `MIT License` ([Crates.io](https://crates.io/crates/chzzk))
* \[Kotlin] [olymika/chzzk-with-me](https://github.com/olymika/chzzk-wih-me) ⭐ 4 | 🐛 0 | 🌐 Kotlin | 📅 2025-06-28 - Coroutine Kotlin API library of Chzzk `Kotlin` `Apache-2.0` ([Maven](https://central.sonatype.com/artifact/org.olymika/chzzk-with-me))
* \[Node.js] [Helloyunho/spark](https://github.com/Helloyunho/spark) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2023-12-26 - 비공식 네이버 스트리밍 서비스 치지직 JavaScript API `Typescript` `Apache-2.0 License` ([NPM](https://www.npmjs.com/package/spark-chzzk))
* \[C++] [Kareus/chzzkpp](https://github.com/Kareus/chzzkpp) ⭐ 1 | 🐛 0 | 🌐 C++ | 📅 2024-12-09 - Unofficial C++ implementation of Chzzk API library `C++` `MIT License`

### OpenAPI

* [dokdo2013/twitchzzk-api](https://github.com/dokdo2013/twitchzzk-api) ⭐ 5 | 🐛 2 | 🌐 TypeScript | 📅 2024-01-02 - Twitch Helix API 호환 Chzzk(치지직) API `Typescript` `AGPL-3.0 License` ([API 문서](https://api.twitchzzk.tv))
...
* [munsy0227/Chzzk-Rekoda](https://github.com/munsy0227/Chzzk-Rekoda) ⭐ 54 | 🐛 0 | 🌐 Python | 📅 2026-09-12 - 치지직 방송을 편하게 자동 녹화하기 위한 프로그램 `Python` `MIT License`
...
* [Buddha7771/ChzzkChat](https://github.com/Buddha7771/ChzzkChat) ⭐ 42 | 🐛 1 | 🌐 Python | 📅 2025-08-31 - 파이썬 치지직 채팅 크롤러 `Python`
...
* [GangOn0215/discord-chzzk-bot-js](https://github.com/GangOn0215/discord-chzzk-bot-js) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2024-01-07 - discord-chzzk-bot discord.js v14 버전으로 만든 비공식 chzzk 알림봇 `Javascript`
...
* [NOOBNUBY/McChzzk](https://github.com/NOOBNUBY/McChzzk) ⭐ 2 | 🐛 0 | 🌐 Kotlin | 📅 2023-12-31 - Minecraft <-> Chzzk plugin `Kotlin` `GPL-3.0 License`
* [apo2073/skChzzk](https://github.com/apo2073/skChzzk) ⭐ 0 | 🐛 1 | 🌐 Kotlin | 📅 2025-10-29 - 마인크래프트 치지직 스크립트 애드온 `Kotlin` `GPL-3.0 license`

### Flow Launcher 플러그인

* [kim0chan/Flow.Launcher.Plugin.CHZZK](https://github.com/kim0chan/Flow.Launcher.Plugin.CHZZK) ⭐ 0 | 🐛 7 | 🌐 TypeScript | 📅 2025-08-10 - Flow Launcher 치지직 플러그인 `Typescript`
